...
```{r human, fig.cap = "Multiverse analysis of the \"Gold Standard\" (Orange: Not pre-registered, coding from expert(s); dotted lines: nulls)"}
set.seed(12121)
...
```{r ridges, fig.cap = "Distribution of best-case correct classification rates by methods (dotted lines: nulls)", echo = FALSE}
require(tidyverse)
require(ggridges)
ireadRDS <- function(fname) {
        readRDS(here::here("intermediate", fname))
