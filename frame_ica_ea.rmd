...
Another issue with the sample size is that unsupervised and semi-supervised methods studied in this benchmark might not work well with a sample size of 100. 
