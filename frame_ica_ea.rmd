...
The regression model suggests that the automatic methods have a significantly lower accuracy than the "gold standard". This supports H1. However, there is no meaning difference between the automatic methods and semisupervised methods, as well as between semisupervised methods and "gold standard". There is not enough evidence to support H2 and H3.
